<?php
	require_once (__DIR__.'/../applepay_includes/apple_pay_conf.php'); ?>
<!DOCTYPE html>
<html lang="ru">
	<head>
		<meta charset="utf-8">
			...
			document.getElementById("applePay").onclick = function(evt) {
				...
				function sendPaymentToken(paymentToken) {
					return new Promise(function(resolve, reject) {
						...
						//};
						xhr.onerror = reject;
						//let body = 'orderNumber=ap_1&pt='+encodeURIComponent(paymentToken.paymentData);
						var data = new FormData();
						paymentToken.orderNumber = "475"
