...
//<div class="alert-ext alert alert-dismissable alert-success" style="position: fixed; z-index: 10002; top: 10px; left: 526px;"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button><p style="margin-right: 15px;">Товар добавлен в корзину</p></div>

        tmpl: '<div class="alert-ext alert alert-dismissable notification ${State}"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><h4 style="white-space: nowrap;">${Title}</h4><p>${Content}</p></div>',
