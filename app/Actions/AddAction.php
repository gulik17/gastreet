            ...
            if ($t_free_count < 1) {
                if ($isAjax) {
                    if ($this->lang == 'en') {
                        ...
                        $array['error'] = 'У Вас максимальное количество билетов Турист для корзины';
                    }
                    echo json_encode($array);
                    exit;
                } else {
                    Enviropment::redirect("basket", "У Вас максимальное количество билетов Турист для корзины", "danger");
                }
            }
        }
