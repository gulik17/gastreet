...
*
*/
class UserGetBiletAction extends AuthorizedUserAction implements IPublicAction {
    public function execute() {
        ...
        $message = $um->generateTicketHtmlMessage($user, $this->lang);
        ...
        try {
            ...
            $html2pdf->setDefaultFont('liberationsans','TrueTypeUnicode');
            ...
            //$html2pdf->addFont('ttslabsb', 'B', 'ttslabsb');
            $html2pdf->writeHTML($message);
            $html2pdf->Output('bilet_' . time() . '.pdf', 'D');
        }
