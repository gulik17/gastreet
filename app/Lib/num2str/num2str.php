<?php
/**
 * Класс для преобразования суммы в сумму прописью
 *
 */
class Strum
{
	...
	private $des = array();
	private $hang = array();
	private $namerub = array();
	private $nametho = array();
	private $namemil = array();
	private $kopeek = array();
	...
	/**
	 * Функция, которая складывает слова в предложения
	 *
	 * @param int $i
	 * @param string $words
	 * @param int $fem
	...
	/**
	 * Функция склоняет рубли рублей и заканчивает прописью
	 *
	 * @param int $L
	 * @return string
	 */
