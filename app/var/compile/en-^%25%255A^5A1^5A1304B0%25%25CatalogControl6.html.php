<?php /* Smarty version 2.6.13, created on 2019-11-28 20:07:59
         compiled from /home/c484884/gastreet.com/www/app/Templates/CatalogControl6.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'link', '/home/c484884/gastreet.com/www/app/Templates/CatalogControl6.html', 19, false),array('modifier', 'dbtexttohtml', '/home/c484884/gastreet.com/www/app/Templates/CatalogControl6.html', 26, false),array('modifier', 'tagtocssclass', '/home/c484884/gastreet.com/www/app/Templates/CatalogControl6.html', 40, false),array('modifier', 'isspeakerpicpic', '/home/c484884/gastreet.com/www/app/Templates/CatalogControl6.html', 41, false),array('modifier', 'tagformat', '/home/c484884/gastreet.com/www/app/Templates/CatalogControl6.html', 43, false),)), $this); ?>
...
<?php else: ?><?php echo $this->_tpl_vars['this']['amObj']->name; ?>
<?php endif; ?></h1>
                    <div class="tickects-video-catalog-page tickects-video-catalog-6 gss-video-watch-catalog-page">
                        <div><a data-target="#video-modal" data-toggle="modal" data-link="3_YXLYJtCC4" data-title="ПРО БИЗНЕС-ШКОЛУ" href="#"><span>Посмотрите ролик<br>про БИЗНЕС-ШКОЛУ</span></a></div>
                    </div>
...
<div class="stick-to-footer container mt-3">
    <div class="instagram-gallery">
        <div class="gallery-col">
            ...
            <img src="/images/collages/school1.jpg">
        </div>
        <div class="gallery-col">
            <img src="/images/collages/school2.jpg">
            <div class="gallery-row">
                <div class="gallery-col-1of2"><img src="/images/collages/school3.jpg"></div>
                <div class="gallery-col-1of2"><img src="/images/collages/school4.jpg"></div>
            </div>
        </div>
        <div class="gallery-col">
            <img src="/images/collages/school5.jpg">
            <div class="gallery-row">
                <div class="gallery-col-1of2"><img src="/images/collages/school6.jpg"></div>
                <div class="gallery-col-1of2"><img src="/images/collages/school7.jpg"></div>
            </div>
            <img src="/images/collages/school8.jpg">
        </div>
    </div>
</div>
