<?php /* Smarty version 2.6.13, created on 2019-11-28 20:07:58
         compiled from /home/c484884/gastreet.com/www/app/Templates/CatalogControl3.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'link', '/home/c484884/gastreet.com/www/app/Templates/CatalogControl3.html', 20, false),array('modifier', 'dbtexttohtml', '/home/c484884/gastreet.com/www/app/Templates/CatalogControl3.html', 27, false),array('modifier', 'tagtocssclass', '/home/c484884/gastreet.com/www/app/Templates/CatalogControl3.html', 40, false),array('modifier', 'isspeakerpicpic', '/home/c484884/gastreet.com/www/app/Templates/CatalogControl3.html', 41, false),array('modifier', 'tagformat', '/home/c484884/gastreet.com/www/app/Templates/CatalogControl3.html', 43, false),)), $this); ?>
...
<?php else: ?><?php echo $this->_tpl_vars['this']['amObj']->name; ?>
<?php endif; ?></h1>
                    <div class="tickects-video-catalog-page tickects-video-catalog-3 gss-video-watch-catalog-page">
                        <div><a data-target="#video-modal" data-toggle="modal" data-link="3_YXLYJtCC4" data-title="<?php if ($this->_tpl_vars['lang'] == 'en'): ?>About MAIN STREET<?php else: ?>О MAIN STREET<?php endif; ?>" href="#"><span><?php if ($this->_tpl_vars['lang'] == 'en'): ?>Watch the video<br>about MAIN STREET<?php else: ?>Посмотрите ролик<br>о MAIN STREET<?php endif; ?></span></a></div>
                    </div>
...
<div class="stick-to-footer container mt-3">
    <div class="instagram-gallery">
        <div class="gallery-col">
            ...
            <img src="/images/collages/business1.jpg">
        </div>
        <div class="gallery-col">
            <img src="/images/collages/business2.jpg">
            <div class="gallery-row">
                <div class="gallery-col-1of2"><img src="/images/collages/business3.jpg"></div>
                <div class="gallery-col-1of2"><img src="/images/collages/business4.jpg"></div>
            </div>
        </div>
        <div class="gallery-col">
            <img src="/images/collages/business5.jpg">
            <div class="gallery-row">
                <div class="gallery-col-1of2"><img src="/images/collages/business6.jpg"></div>
                <div class="gallery-col-1of2"><img src="/images/collages/business7.jpg"></div>
            </div>
            <img src="/images/collages/business8.jpg">
        </div>
    </div>
</div>
