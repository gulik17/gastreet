<?php /* Smarty version 2.6.13, created on 2019-11-28 16:26:34
         compiled from /home/c484884/gastreet.com/www/app/Templates/CatalogControl9.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'link', '/home/c484884/gastreet.com/www/app/Templates/CatalogControl9.html', 19, false),array('modifier', 'dbtexttohtml', '/home/c484884/gastreet.com/www/app/Templates/CatalogControl9.html', 28, false),array('modifier', 'tagtocssclass', '/home/c484884/gastreet.com/www/app/Templates/CatalogControl9.html', 57, false),array('modifier', 'isspeakerpicpic', '/home/c484884/gastreet.com/www/app/Templates/CatalogControl9.html', 58, false),array('modifier', 'tagformat', '/home/c484884/gastreet.com/www/app/Templates/CatalogControl9.html', 60, false),)), $this); ?>
...
<?php endif; ?></h1>
                        ...
                        <div class="tickects-video-catalog-page tickects-video-catalog-9 gss-video-watch-catalog-page">
                            <div><a data-target="#video-modal" data-toggle="modal" data-link="76lIiYRRHSw" data-title="<?php if ($this->_tpl_vars['lang'] == 'en'): ?>About CHEF STREET<?php else: ?>О CHEF STREET<?php endif; ?>" href="#"><span><?php if ($this->_tpl_vars['lang'] == 'en'): ?>Watch the video<br>about CHEF STREET<?php else: ?>Посмотрите ролик<br>о CHEF STREET<?php endif; ?></span></a></div>
                        </div>
...
<?php endif; ?></div>
                        ...
                        <div class="row hidden">
                            <div class="col-md-12">
                                <div class="h3">Модераторы площадки:</div>
                            </div>
                            <div class="col-md-3 grid-entry js-grid-entry">
                                <div class="h4">22 мая</div>
                                <a class="person-teaser js-popover" href="#" data-popover="#popover-win-430" data-timer="on">
                                    <img src="/images/speackers/resized/430.jpg?v=1522919929" data-ratio="1">
                                    <div class="about">
                                        <p class="name">Марк<br>Стаценко</p>
                                    </div>
                                </a>
                            </div>
                        </div>
...
<div class="stick-to-footer container mt-3">
    <div class="instagram-gallery">
        <div class="gallery-col">
            ...
            <img src="/images/collages/chef1.jpg">
        </div>
        <div class="gallery-col"><img src="/images/collages/chef2.jpg">
            <div class="gallery-row">
                <div class="gallery-col-1of2"><img src="/images/collages/chef3.jpg"></div>
                <div class="gallery-col-1of2"><img src="/images/collages/chef4.jpg"></div>
            </div>
        </div>
        <div class="gallery-col">
            <img src="/images/collages/chef5.jpg">
            <div class="gallery-row">
                <div class="gallery-col-1of2"><img src="/images/collages/chef6.jpg"></div>
                <div class="gallery-col-1of2"><img src="/images/collages/chef7.jpg"></div>
            </div>
            <img src="/images/collages/chef8.jpg">
        </div>
    </div>
</div>
