<?php /* Smarty version 2.6.13, created on 2019-11-29 04:01:51
         compiled from /home/c484884/gastreet.com/www/app/Templates/CatalogControl16.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'link', '/home/c484884/gastreet.com/www/app/Templates/CatalogControl16.html', 19, false),array('modifier', 'dbtexttohtml', '/home/c484884/gastreet.com/www/app/Templates/CatalogControl16.html', 29, false),)), $this); ?>
...
<?php else: ?><?php echo $this->_tpl_vars['this']['amObj']->name; ?>
<?php endif; ?></h1>
                        <div class="tickects-video-catalog-page tickects-video-catalog-8 gss-video-watch-catalog-page">
                            <div><a data-target="#video-modal" data-toggle="modal" data-link="9lw3RR8kzk4" data-title="О GOODFOOD" href="#"><span>Посмотрите ролик<br>о GOODFOOD</span></a></div>
                        </div>
...
<div class="stick-to-footer container mt-3">
    <div class="instagram-gallery">
        <div class="gallery-col">
            ...
            <img src="/images/collages/beer1.jpg">
        </div>
        <div class="gallery-col">
            <img src="/images/collages/beer2.jpg">
            <div class="gallery-row">
                <div class="gallery-col-1of2"><img src="/images/collages/beer3.jpg"></div>
                <div class="gallery-col-1of2"><img src="/images/collages/beer4.jpg"></div>
            </div>
        </div>
        <div class="gallery-col">
            <img src="/images/collages/beer5.jpg">
            <div class="gallery-row">
                <div class="gallery-col-1of2"><img src="/images/collages/beer6.jpg"></div>
                <div class="gallery-col-1of2"><img src="/images/collages/beer7.jpg"></div>
            </div>
            <img src="/images/collages/beer8.jpg">
        </div>
    </div>
</div>
