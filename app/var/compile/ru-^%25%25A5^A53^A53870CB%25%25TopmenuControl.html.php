<?php /* Smarty version 2.6.13, created on 2020-01-15 16:56:28
...
" class="indicator-toggle cashback"><span>Билеты</span></a></li>
...
" style="color: red;"><span class="glyphicon glyphicon-log-out" aria-hidden="true" title="Выйти"></span> <span>Выйти</span></a>
                        <?php else: ?>
                            <li class="for-mobile"><a href="<?php echo smarty_function_link(array('show' => 'usereditprofile'), $this);?>
...
"><span class="glyphicon glyphicon-log-out" aria-hidden="true" title="Выйти"></span> <span>Выйти</span></a></li>
                        <?php endif; ?>
                    <?php endif; ?>
                </ul>
...
"><i class="fa fa-sign-out" aria-hidden="true"></i> <span>Выйти</span></a></li>
                            </ul>
                        </div>
                    <?php else: ?>
                        <div class="dropdown">
