<?php /* Smarty version 2.6.13, created on 2019-12-04 23:08:24
         compiled from /home/c484884/gastreet.com/www/app/Templates/AvatarMobileControl.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'loadscript', '/home/c484884/gastreet.com/www/app/Templates/AvatarMobileControl.html', 2, false),)), $this); ?>
...
<div style="padding:15px;color:grey;background:rgba(0,0,0,0.30);position:absolute;bottom:0;right:20px;z-index: 1100;font-size: 15px; display: none;" id="mobileCropper_cancel">Отмена</div>

<div style="padding:15px;color:grey;background:rgba(0,0,0,0.30);position:absolute;bottom:0;left:20px;z-index: 1100;font-size: 15px; display: none;" id="mobileCropper_getResult">Загрузить</div>

<div class="l-container">
    <div class="page-container" id="page-container">
        <div class="gss-avatar">
            <div class="gss-avatar-upl-text hidden">Загрузите фотографию</div>
            <form id="imageform" class="hidden" method="post" action="app/avatar/ajaxImageUpload.php" style="clear:both">
                <div class="">
            ...
            <div class="wrapper">
                ...
                <div class="block_right">
                    <div class="gss-avatar-choose-text">Выберите фильтр</div>
                    <div class="prev">

                        <div class="box">
                            <ul class="gss-avatar-choose-ul">
                        ...
                        <div class="gss-avatar-share-text">Скачайте фотографию</div>
                        <div class="share">
