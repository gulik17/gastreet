<?php /* Smarty version 2.6.13, created on 2019-11-29 04:01:56
         compiled from /home/c484884/gastreet.com/www/app/Templates/CatalogControl2.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'link', '/home/c484884/gastreet.com/www/app/Templates/CatalogControl2.html', 21, false),array('function', 'declension', '/home/c484884/gastreet.com/www/app/Templates/CatalogControl2.html', 74, false),array('modifier', 'dbtexttohtml', '/home/c484884/gastreet.com/www/app/Templates/CatalogControl2.html', 31, false),array('modifier', 'tstocheck', '/home/c484884/gastreet.com/www/app/Templates/CatalogControl2.html', 42, false),array('modifier', 'dateformat', '/home/c484884/gastreet.com/www/app/Templates/CatalogControl2.html', 49, false),array('modifier', 'getidyoutubevideo', '/home/c484884/gastreet.com/www/app/Templates/CatalogControl2.html', 50, false),array('modifier', 'isproductpic', '/home/c484884/gastreet.com/www/app/Templates/CatalogControl2.html', 52, false),array('modifier', 'round0', '/home/c484884/gastreet.com/www/app/Templates/CatalogControl2.html', 71, false),)), $this); ?>
...
<?php endif; ?></h1>
                        <div class="tickects-video-catalog-page tickects-video-catalog-2 gss-video-watch-catalog-page">
                            <div class="js-videos-gallery">
                                <div><a data-target="#video-modal" data-toggle="modal" data-link="R9eZ8shs0OY" data-title="О NIGHT LIFE" href="#"><span>Посмотрите ролик<br>о NIGHT LIFE</span></a></div>
                            </div>
                        </div>
...
">
                                    <?php else: ?>
                                        <img class="photo" src="/content/event6.jpg">
                                    <?php endif; ?>
                                </figure>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header p-3">
                                    <p class="title m-0 text-dark"><?php echo $this->_tpl_vars['product']->name; ?>
</p>
...
">
                                            <?php else: ?>
                                                <img class="img-fluid" style="width: 100%;" src="/content/event6.jpg">
                                            <?php endif; ?>
                                        </figure>
                                    <?php endif; ?>
                                    <div class="desc text-dark"><?php echo ((is_array($_tmp=$this->_tpl_vars['product']->description)) ? $this->_run_mod_handler('dbtexttohtml', true, $_tmp) : smarty_modifier_dbtexttohtml($_tmp)); ?>
</div>
                                    <?php if ($this->_tpl_vars['product']->leftCount > 0 && $this->_tpl_vars['canShowButton'] && $this->_tpl_vars['app'] != 1 && ! $this->_tpl_vars['this']['productId']): ?><div class="order"><a href="/index.php?do=add&product=<?php echo $this->_tpl_vars['product']->id; ?>
"><i class="fa fa-shopping-cart" aria-hidden="true"></i></a></div><?php endif; ?>
                                </div>
                            </div>
                        </div>
                    </div>
...
<div class="stick-to-footer container mt-3">
    <div class="instagram-gallery dark-theme">
        <div class="gallery-col">
            <h2 class="section-headline" style="margin-top: 4rem;margin-bottom: 2.75rem;color: #fff;">Gastreet<br> History</h2>
            <img src="/images/collages/nightpage1.jpg">
        </div>
        <div class="gallery-col">
            <img src="/images/collages/nightpage2.jpg">
            <div class="gallery-row">
                <div class="gallery-col-1of2"><img src="/images/collages/nightpage3.jpg"></div>
                <div class="gallery-col-1of2"><img src="/images/collages/nightpage4.jpg"></div>
            </div>
        </div>
        <div class="gallery-col">
            <img src="/images/collages/nightpage5.jpg">
            <div class="gallery-row">
                <div class="gallery-col-1of2"><img src="/images/collages/nightpage6.jpg"></div>
                <div class="gallery-col-1of2"><img src="/images/collages/nightpage7.jpg"></div>
            </div>
            <img src="/images/collages/nightpage8.jpg">
        </div>
    </div>
</div>
