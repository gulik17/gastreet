<?php /* Smarty version 2.6.13, created on 2019-11-28 15:34:50
         compiled from /home/c484884/gastreet.com/www/app/Templates/CatalogControl11.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'link', '/home/c484884/gastreet.com/www/app/Templates/CatalogControl11.html', 19, false),array('modifier', 'dbtexttohtml', '/home/c484884/gastreet.com/www/app/Templates/CatalogControl11.html', 23, false),)), $this); ?>
...
<div class="stick-to-footer container mt-3 d-none">
    <div class="instagram-gallery">
        <div class="gallery-col">
            ...
            <img src="/images/collages/bbq1.jpg">
        </div>
        <div class="gallery-col">
            <img src="/images/collages/bbq2.jpg">
            <div class="gallery-row">
                <div class="gallery-col-1of2"><img src="/images/collages/bbq3.jpg"></div>
                <div class="gallery-col-1of2"><img src="/images/collages/bbq4.jpg"></div>
            </div>
        </div>
        <div class="gallery-col">
            <img src="/images/collages/bbq5.jpg">
            <div class="gallery-row">
                <div class="gallery-col-1of2"><img src="/images/collages/bbq6.jpg"></div>
                <div class="gallery-col-1of2"><img src="/images/collages/bbq7.jpg"></div>
            </div>
            <img src="/images/collages/bbq8.jpg">
        </div>
    </div>
</div>
