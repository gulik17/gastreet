<?php /* Smarty version 2.6.13, created on 2019-11-28 15:25:13
         compiled from /home/c484884/gastreet.com/www/app/Templates/CatalogControl5.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'link', '/home/c484884/gastreet.com/www/app/Templates/CatalogControl5.html', 19, false),array('modifier', 'dbtexttohtml', '/home/c484884/gastreet.com/www/app/Templates/CatalogControl5.html', 26, false),array('modifier', 'tagtocssclass', '/home/c484884/gastreet.com/www/app/Templates/CatalogControl5.html', 40, false),array('modifier', 'isspeakerpicpic', '/home/c484884/gastreet.com/www/app/Templates/CatalogControl5.html', 41, false),array('modifier', 'tagformat', '/home/c484884/gastreet.com/www/app/Templates/CatalogControl5.html', 43, false),)), $this); ?>
...
<?php endif; ?></h1>
                        <div class="tickects-video-catalog-page tickects-video-catalog-5 gss-video-watch-catalog-page">
                            <div><a data-target="#video-modal" data-toggle="modal" data-link="KwT5ttKxmV0" data-title="ПРО REBRO" href="#"><span>Посмотрите ролик<br>про REBRO</span></a></div>
                        </div>
...
<div class="stick-to-footer container mt-3">
    <div class="instagram-gallery">
        <div class="gallery-col">
            ...
            <img src="/images/collages/rebro1.jpg">
        </div>
        <div class="gallery-col">
            <img src="/images/collages/rebro2.jpg">
            <div class="gallery-row">
                <div class="gallery-col-1of2"><img src="/images/collages/rebro3.jpg"></div>
                <div class="gallery-col-1of2"><img src="/images/collages/rebro4.jpg"></div>
            </div>
        </div>
        <div class="gallery-col">
            <img src="/images/collages/rebro5.jpg">
            <div class="gallery-row">
                <div class="gallery-col-1of2"><img src="/images/collages/rebro6.jpg"></div>
                <div class="gallery-col-1of2"><img src="/images/collages/rebro7.jpg"></div>
            </div>
            <img src="/images/collages/rebro8.jpg">
        </div>
    </div>
</div>
